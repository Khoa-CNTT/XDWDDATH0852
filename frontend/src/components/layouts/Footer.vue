...
onMounted(() => {
  ...
  `; // Thiết lập kích thước nút chat
  script.dataset.image = 'https://i.pinimg.com/736x/52/26/1a/52261a8e8dc68dab5f4d818b9e7d14e1.jpg'; // Ảnh cho bot
  document.body.appendChild(script); // Gắn script vào body của trang
});
</script>